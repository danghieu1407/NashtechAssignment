...
class BookRepository implements BaseInterface
{
    ...
    public function  getBookByIDCustomerReview(Request $params)
    {
        ...
        $books = $this->bookModel->finalPriceOfBook()
            ...
            ->select('book.id', 'category.category_name', 'book.book_title','author.author_name','check_final_price.book_cover_photo','check_final_price.book_price','check_final_price.discount_price','check_final_price.discount_start_date','check_final_price.discount_end_date','check_final_price.final_price','book.book_summary')
            ->get();
        return $books ;
    }
